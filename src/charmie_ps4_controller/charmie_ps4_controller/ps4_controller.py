...
import threading
import time
from charmie_interfaces.msg import PS4Controller, DetectedObject, DetectedPerson
...
class TaskMain():
    ...
    def __init__(self, robot: RobotStdFunctions):
        ...
        # crete thread to listen to the controller
        th_con = threading.Thread(target=self.thread_controller, args=(), daemon=True)
        th_con.start()
    ...
    def main(self):
        while True:
            self.update_controller_variables()
            time.sleep(0.05)
