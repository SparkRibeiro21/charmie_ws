...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "debug_laundry_basket = charmie_debug.debug_laundry_basket:main",
            "debug_llm = charmie_debug.debug_llm:main",
            "debug_llm_task = charmie_debug.debug_llm_task:main",
            ...
            "debug_sdnl_navigation = charmie_debug.debug_sdnl_navigation:main",
