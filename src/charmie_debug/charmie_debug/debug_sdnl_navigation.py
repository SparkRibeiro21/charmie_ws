        ...
        while True:
            ...
            if self.state == Waiting_for_start_button:
                ...
                while True:
                    ...
                    self.robot.sdnl_move_to_position(move_coords=self.NAVIGATION_TARGET5, first_rotate=True, orient_after_move=False, reached_radius=1.0, print_feedback=True, wait_for_end_of=True)
                    time.sleep(5.0)
                    self.robot.sdnl_move_to_position(move_coords=self.NAVIGATION_TARGET6, first_rotate=False, orient_after_move=True, reached_radius=1.0, print_feedback=True, wait_for_end_of=True)
                    time.sleep(5.0)
