        ...
        while True:
            ...
            if self.state == Waiting_for_start_button:
                ...
                while True:
                    ...
                    time.sleep(1.0)
                    self.robot.set_speech(filename="furniture/"+self.robot.get_furniture_from_object_class(self.robot.get_object_class_from_object(o)), show_in_face=True, long_pause_show_in_face=True, wait_for_end_of=True)
                    time.sleep(5.0)
                    ...
                    self.robot.set_speech(filename="objects_names/"+o.replace(" ","_").lower(), show_in_face=True, long_pause_show_in_face=True, wait_for_end_of=True)
                    time.sleep(5.0)
