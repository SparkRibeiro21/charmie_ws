        ...
        while True:
            ...
            if self.state == Prompt_free_yolo_world:
                ...
                while True:
                    ...
                    basket = self.robot.search_for_objects(tetas = [[0,-45], [-20, -45], [20, -45]], time_in_each_frame=10.0, time_wait_neck_move_pre_each_frame=0.0, detect_tv_prompt_head=True, visual_prompts=["laundry_basket_head_cam"], minimum_tv_prompt_confidence=0.20)
                    print("DONE HEAD PROMPT")
                    ...
                    for obj in basket:
                        ...
                        base_approach_x = b.position_relative.x - ROBOT_DIAMETER/2
                        base_approach_y = b.position_relative.y - ROBOT_DIAMETER/2

                        print("BAsket coords:", b.position_relative.x, b.position_relative.y, b.position_relative.z)
                        print("Base Adjusts:", base_approach_x, base_approach_y)

                        self.robot.adjust_omnidirectional_position(dx=base_approach_x, dy=base_approach_y, safety=True, wait_for_end_of=True)
