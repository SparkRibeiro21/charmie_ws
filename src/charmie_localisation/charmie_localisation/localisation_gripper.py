...
class LocalisationNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Initialised CHARMIE Gripper Base Localisation Node")
        ...
        self.pose_publisher = self.create_publisher(Pose2D, "gripper_base_localisation", 10)
    ...
    def publish_robot_pose(self):
        try:
            ...
            if self.tf_buffer.can_transform("map", "joint6", requested_time):
                # Get robot pose in map frame
                transform = self.tf_buffer.lookup_transform("map", "joint6", requested_time)
