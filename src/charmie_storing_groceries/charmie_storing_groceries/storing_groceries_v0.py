    ...
    def main(self):
        ...
        while True:
            ...
            if self.state == self.Waiting_for_task_start:
                ...
                self.set_speech(filename="storing_groceries/sg_moving_table", wait_for_end_of=True)

                ###### MOVEMENT TO THE KITCHEN COUNTER

                self.set_speech(filename="storing_groceries/sb_arrived_table", wait_for_end_of=True)
                ...
                self.set_speech(filename="storing_groceries/sg_arrived_cabinet", wait_for_end_of=True)
