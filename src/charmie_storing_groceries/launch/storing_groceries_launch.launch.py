...
def generate_launch_description():
    ...
    both_cameras_launch_file = PythonLaunchDescriptionSource([os.path.join(
        get_package_share_directory('realsense2_camera'), 'launch', 'charmie_multi_camera_launch.py'
    )])

    charmie_both_cameras_launch_description = IncludeLaunchDescription(both_cameras_launch_file)
    ...
    storing_groceries = Node(package='charmie_storing_groceries',
                executable='storing_groceries_v0',
                name='storing_groceries_v0',
                emulate_tty=True
                )
