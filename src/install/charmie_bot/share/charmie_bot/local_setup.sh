...
: ${AMENT_CURRENT_PREFIX:="/home/utilizador/charmie_ws/src/install/charmie_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/charmie_bot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/charmie_bot/environment/path.sh"
