...
words_dict = {}
	words_dict[
	words_dict["help"] = ["help", "helping", "chores", "chore", "task", "tasks", "give me a hand"]
	words_dict["follow"] = ["follow", "following"]
	words_dict["garbage"] = ["garbage", "trash", "dress", "recycle", "bin", "threshwex"]
	words_dict["entrance"] = ["entrance", "outside", "door"]
	words_dict["office"] = ["office", "meeting", "room"]
	words_dict["kitchen"] = ["kitchen", "oven", "microwave", "cook"]
	words_dict["emergency"] = ["stop", "emergency"]
	words_dict["start"] = ["start", "go", "begin"]
	words_dict["luggage"] = ["luggage", "carry", "karimalaguch"]
	words_dict["clean"] = ["clean", "store", "storing", "groceries"]
	words_dict["point"] = ["point", "show"]
	words_dict["place"] = ["place", "put"]
	words_dict["arrive"] = ["arrive", "finish", "end"]
	words_dict["floor"] = ["floor", "ground", "drop", "place"]
	words_dict["give"] = ["give", "me"]
	words_dict["cabinet"] = ["cabinet", "shelf", "shelves", "cupboard"]
	words_dict["table"] = ["table", "counter", "desk"]
	words_dict["drop"] = ["drop", "fall"]
	words_dict["pick"] = ["pick", "collect", "fetch"]
	words_dict["continue"] = ["continue", "keep going", "move on"]
	words_dict["break"] = ["break", "other"]
"""
