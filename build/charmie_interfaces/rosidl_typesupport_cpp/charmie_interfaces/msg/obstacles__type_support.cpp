...
static const _Obstacles_type_support_symbol_names_t _Obstacles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, charmie_interfaces, msg, Obstacles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, charmie_interfaces, msg, Obstacles)),
  }
};
...
{
  return &::charmie_interfaces::msg::rosidl_typesupport_cpp::Obstacles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, charmie_interfaces, msg, Obstacles)() {
  return get_message_type_support_handle<charmie_interfaces::msg::Obstacles>();
}
