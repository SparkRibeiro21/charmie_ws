...
static const _DetectedPerson_type_support_symbol_names_t _DetectedPerson_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, charmie_interfaces, msg, DetectedPerson)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, charmie_interfaces, msg, DetectedPerson)),
  }
};
...
{
  return &::charmie_interfaces::msg::rosidl_typesupport_cpp::DetectedPerson_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, charmie_interfaces, msg, DetectedPerson)() {
  return get_message_type_support_handle<charmie_interfaces::msg::DetectedPerson>();
}
