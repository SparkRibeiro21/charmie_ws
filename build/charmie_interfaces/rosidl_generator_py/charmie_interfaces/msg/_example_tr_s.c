...
bool charmie_interfaces__msg__example_tr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("charmie_interfaces.msg._example_tr.ExampleTR", full_classname_dest, 44) == 0);
  }
  charmie_interfaces__msg__ExampleTR * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of ExampleTR */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("charmie_interfaces.msg._example_tr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ExampleTR");
