...
#include "charmie_interfaces/msg/detail/multi_objects__rosidl_typesupport_fastrtps_c.h"
...
using _MultiObjects__ros_msg_type = charmie_interfaces__msg__MultiObjects;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MultiObjects__ros_msg_type * ros_message = static_cast<const _MultiObjects__ros_msg_type *>(untyped_ros_message);
  // Field name: objects
  {
  ...
  void * untyped_ros_message)
{
  ...
  _MultiObjects__ros_msg_type * ros_message = static_cast<_MultiObjects__ros_msg_type *>(untyped_ros_message);
  // Field name: objects
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
    ...
    if (ros_message->objects.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->objects);
    }
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'objects'\n");
        return false;
      }
    }
  }
...
size_t get_serialized_size_charmie_interfaces__msg__MultiObjects(
  const void * untyped_ros_message,
...
static uint32_t _MultiObjects__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_charmie_interfaces__msg__MultiObjects(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_charmie_interfaces
size_t max_serialized_size_charmie_interfaces__msg__MultiObjects(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_charmie_interfaces__msg__MultiObjects(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_MultiObjects = {
...
static rosidl_message_type_support_t _MultiObjects__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MultiObjects,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, charmie_interfaces, msg, MultiObjects)() {
  return &_MultiObjects__type_support;
}
