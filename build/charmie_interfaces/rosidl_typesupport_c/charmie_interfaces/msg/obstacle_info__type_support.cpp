...
static const _ObstacleInfo_type_support_symbol_names_t _ObstacleInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, charmie_interfaces, msg, ObstacleInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, charmie_interfaces, msg, ObstacleInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, charmie_interfaces, msg, ObstacleInfo)() {
  return &::charmie_interfaces::msg::rosidl_typesupport_c::ObstacleInfo_message_type_support_handle;
}
