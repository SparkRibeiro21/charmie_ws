...
static const _DetectedPerson_type_support_symbol_names_t _DetectedPerson_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, charmie_interfaces, msg, DetectedPerson)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, charmie_interfaces, msg, DetectedPerson)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, charmie_interfaces, msg, DetectedPerson)() {
  return &::charmie_interfaces::msg::rosidl_typesupport_c::DetectedPerson_message_type_support_handle;
}
