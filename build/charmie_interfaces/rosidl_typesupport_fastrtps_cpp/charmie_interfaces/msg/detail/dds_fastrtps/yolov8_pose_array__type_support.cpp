...
#include "charmie_interfaces/msg/detail/yolov8_pose_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const charmie_interfaces::msg::Yolov8Pose &,
...
cdr_serialize(
  const charmie_interfaces::msg::Yolov8PoseArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  charmie_interfaces::msg::Yolov8PoseArray & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_charmie_interfaces
max_serialized_size_Yolov8PoseArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        charmie_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Yolov8Pose(
...
{
  auto typed_message =
    static_cast<const charmie_interfaces::msg::Yolov8PoseArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<charmie_interfaces::msg::Yolov8PoseArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Yolov8PoseArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const charmie_interfaces::msg::Yolov8PoseArray *>(
...
{
  return max_serialized_size_Yolov8PoseArray(full_bounded, 0);
}

static message_type_support_callbacks_t _Yolov8PoseArray__callbacks = {
...
static rosidl_message_type_support_t _Yolov8PoseArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Yolov8PoseArray__callbacks,
...
{
  return &charmie_interfaces::msg::typesupport_fastrtps_cpp::_Yolov8PoseArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, charmie_interfaces, msg, Yolov8PoseArray)() {
  return &charmie_interfaces::msg::typesupport_fastrtps_cpp::_Yolov8PoseArray__handle;
}
