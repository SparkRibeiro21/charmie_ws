...
static const _IMUInfo_type_support_symbol_names_t _IMUInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, realsense2_camera_msgs, msg, IMUInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, realsense2_camera_msgs, msg, IMUInfo)),
  }
};
...
{
  return &::realsense2_camera_msgs::msg::rosidl_typesupport_cpp::IMUInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, realsense2_camera_msgs, msg, IMUInfo)() {
  return get_message_type_support_handle<realsense2_camera_msgs::msg::IMUInfo>();
}
